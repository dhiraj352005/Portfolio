    ...
    <section id="achievements" className="relative py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight flex items-center justify-center gap-2">
          Achievements <Sparkles className="w-6 h-6 text-amber-300 animate-pulse" />
        </h2>
        ...
        {achievements.map((item) => {
          ...
          return (
            <div
              ...
              className="group relative bg-[#0c1527]/70 hover:bg-[#0c1527]/95 border border-slate-800/90 hover:border-cyan-500/50 backdrop-blur-md rounded-2xl p-6 transition-all duration-300 shadow-xl hover:shadow-cyan-500/10 hover:-translate-y-1 flex flex-col justify-between overflow-hidden"
            >
              {/* Dark Overlay Wrapper for Readability */}
              <div className="absolute inset-0 bg-[#0c1527]/85 backdrop-blur-[2px] z-0 group-hover:bg-[#0c1527]/80 transition-colors"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-[#060b17] via-[#0c1527]/90 to-[#0c1527]/75 z-0 pointer-events-none"></div>
              ...
              <div className="relative z-10 flex flex-col justify-between h-full">
                ...
                <div className="pt-4 border-t border-slate-800/80 mt-auto">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <div className="text-base font-extrabold text-white group-hover:text-cyan-400 transition-colors flex items-center gap-1.5">
                    ...
                    <div className="w-7 h-7 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 group-hover:text-cyan-400 group-hover:border-cyan-500/40 transition-all">
