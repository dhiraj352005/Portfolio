      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-5">
        {filteredSkills.map((skill, idx) => {
          ...
          return (
            <div
              key={idx}
              className="group bg-[#0c1527]/70 hover:bg-[#0c1527]/95 border border-slate-800/90 hover:border-cyan-500/50 rounded-2xl p-4 sm:p-5 flex flex-col items-center justify-center gap-3 transition-all duration-300 shadow-lg hover:shadow-cyan-500/10 hover:-translate-y-1 text-center"
            >
              <div 
                className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 group-hover:border-cyan-500/30 flex items-center justify-center transition-all group-hover:scale-110"
                style={{
